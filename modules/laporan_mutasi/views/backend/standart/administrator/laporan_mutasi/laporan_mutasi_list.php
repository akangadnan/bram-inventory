...
<script type="text/javascript">
	...
	function domo() {
		...
		$('*').bind('keydown', 'Ctrl+a', function assets() {
			window.location.href = BASE_URL + '/administrator/laporan_mutasi/add';
			return false;
		});
...
<section class="content-header">
	<h1>
		Laporan Mutasi<small><?= cclang('list_all'); ?></small>
	</h1>
	<ol class="breadcrumb">
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form name="form_laporan_mutasi" id="form_laporan_mutasi" action="<?= base_url('administrator/laporan_mutasi/index'); ?>">
				<div class="box box-primary">
					<div class="box-body">
						<div class="box box-widget widget-user-2">
							<div class="widget-user-header">
							<div class="row pull-right">
								<?php is_allowed('laporan_mutasi_pdf', function(){?>
								<a class="btn btn-flat btn-success" target="_blank" title="Export to PDF" href="<?= site_url('administrator/laporan_mutasi/export_excel?c='.$this->input->get('c').'&g='.$this->input->get('g').'&p='.$this->input->get('p').'&m='.$this->input->get('m').'&y='.$this->input->get('y').'&start='.$this->input->get('start').'&end='.$this->input->get('end')); ?>">
								...
								<h3 class="widget-user-username">Laporan Mutasi</h3>
								<h5 class="widget-user-desc">Semua data laporan mutasi
									<i class="label bg-yellow"><?= $laporan_mutasi_counts; ?> <?= cclang('items'); ?></i>
								</h5>
							</div>
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-sm-1 padd-left-0">
										<a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= base_url('administrator/laporan_mutasi');?>" title="<?= cclang('reset_filter'); ?>">
							...
							<div class="table-responsive">
								...
								?>
										<tr>
											...
											<td><?= !empty($laporan_mutasi[$item->barang_id]['stok_akhir']) ? $laporan_mutasi[$item->barang_id]['stok_akhir'] : 0?></td>
										</tr>
								<?php
									}

									if ($laporan_mutasi_counts == 0) {
								?>
									<tr>
										<td colspan="100">
