...
class Model_bidang extends MY_Model {
    ...
    private $primary_key    = 'bidang_id';
    private $table_name     = 'bidang';
    public $field_search   = ['bidang_nama', 'bidang_subyek'];
    public $sort_option = ['bidang_id', 'DESC'];
