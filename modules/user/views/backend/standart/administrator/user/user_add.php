						...
						<div class="box box-widget widget-user-2">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<small class="info help-block">The password character must 6 or more.</small>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select class="form-control chosen chosen-select" name="group[]" id="group" tab-index="5" multiple placeholder="Select groups">
								<?php
									$condition = [
										'id !=' => '1',
									];

									foreach (db_get_all_data('aauth_groups', $condition) as $row): ?>
