...
<section class="content-header">
	<h1>
		Mutasi Keluar <small><?= cclang('new', ['Mutasi Keluar']); ?> </small>
	</h1>
	<ol class="breadcrumb">
				...
				<div class="box-body ">
					...
					<div class="box box-widget widget-user-2">
						...
						<div class="widget-user-header ">
							...
							<h5 class="widget-user-desc"><?= cclang('new', ['Mutasi Keluar']); ?></h5>
							<hr>
						</div>
						<?= form_open('', [
						...
						<div class="form-group group-mutasi_keluar_tgl_keluar ">
							...
							<div class="col-sm-6">
								<div class="input-group date col-sm-8">
									<input type="text" class="form-control pull-right datepicker" name="mutasi_keluar_tgl_keluar" placeholder="Tanggal Keluar" id="mutasi_keluar_tgl_keluar">
								</div>
						...
						<div class="form-group group-mutasi_keluar_status ">
							<label for="mutasi_keluar_status" class="col-sm-2 control-label">Status <i
									class="required">*</i>
							</label>
							<div class="col-sm-8">
						...
						<div class="form-group group-mutasi_keluar_keterangan ">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="mutasi_keluar_keterangan"
									id="mutasi_keluar_keterangan" placeholder="Keterangan"
									value="<?= set_value('mutasi_keluar_keterangan'); ?>">
								<small class="info help-block">
								</small>
							</div>
						</div>
												...
												<tbody>
													<tr id="inputFormRow">
														...
														<?php foreach(db_get_all_data('barang') as $row) {?>
																<option value="<?= $row->barang_id;?>"><?= $row->barang_nama; ?> (<?= join_multi_select($row->barang_satuan_id, 'satuan_barang', 'satuan_id', 'satuan_nama'); ?>) </option>
														<?php }; ?>
															</select>
														</td>
...
<script>
	$(document).ready(function () {
		...
		$('.btn_save').click(function () {
			...
			$.ajax({
					url: BASE_URL + '/administrator/mutasi_keluar/add_save',
					type: 'POST',
					dataType: 'json',
					data: data_post,
				})
